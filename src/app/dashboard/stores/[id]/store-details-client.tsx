      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <div className="text-3xl font-bold text-teal-600">{store._count?.customers || 0}</div>
          </div>
          <div className="bg-gradient-to-br from-cyan-500 to-teal-600 p-6 rounded-lg shadow-md text-white">
